...
maali -t system-gcc -v 11.3.0 -c nimbus

#maali -t R -v 3.6.3 -c $1 
maali -t R -v 4.0.5 -c nimbus
echo "#"
echo "# you should be able to run rstudio"
echo "# this is done using the following command"
echo "# "
echo "# echo "rsession-which-r=/nimbus/ubuntu22.04/apps/r/4.0.5/bin/R" | sudo tee -a /etc/rstudio/rserver.conf"
echo " "
